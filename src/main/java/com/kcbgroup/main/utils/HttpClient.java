...
public class HttpClient {
    ...
    public HashMap<String, String> callT24(String requestXml) {
        ...
        final String URL = customProperties.getBaseUrl() + customProperties.getBaseResource();

        logger.info("------------------------- T24 REQUEST & ENDPOINT -------------------------");
        String saveReq = "";
